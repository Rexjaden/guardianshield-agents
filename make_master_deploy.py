def create_master_deploy():
    # We will generate a python script that generates the bash script
    # This is meta-programming to ensure clean heredocs
...
"""
    ...
    # Force LF for Linux
    with open('DEPLOY_MASTER_STACK.sh', 'w', encoding='utf-8', newline='\n') as f:
        f.write(script_content)
    
    print("DEPLOY_MASTER_STACK.sh created successfully.")

if __name__ == "__main__":
    create_master_deploy()
