#!/bin/bash
# 🛡️ GuardianShield Website Deployer
# Copy and Paste this ENTIRE text into your Cloud Shell

echo "🚀 Deploying GuardianShield Website..."

# 1. Setup Directories
mkdir -p assets
mkdir -p frontend/js

# 2. Deploy HTML (Main Landing Page)
# This is the exact content of professional-landing.html renamed to index.html
...
<head>
    ...
    <script src="frontend/js/token-sale.js"></script>
...
<body>
    <header class="header">
        <div class="nav-container">
            <div class="logo">
                <img src="assets/gs-token-logo.png" alt="GuardianShield Token" class="logo-image">
    ...
    <main class="main-content">
        ...
        <section id="home" class="hero">
            ...
            <img src="assets/gs-token-logo.png" alt="GuardianShield Token" class="hero-logo">
                ...
                <div class="agents-showcase-grid">
                    <div class="agent-card guardian">
                        <div class="agent-avatar">
                            <img src="assets/guardian-avatar.png" alt="Guardian - Supreme Commander">
                        </div>
                    ...
                    <div class="agent-card prometheus">
                        <div class="agent-avatar">
                            <img src="assets/prometheus-avatar.png" alt="Prometheus - Threat Hunter">
                        </div>
                    ...
                    <div class="agent-card silva">
                        <div class="agent-avatar">
                            <img src="assets/silva-avatar.png" alt="Silva - Network Guardian">
                        </div>
                    ...
                    <div class="agent-card turlo">
                        <div class="agent-avatar">
                            <img src="assets/turlo-avatar.png" alt="Turlo - Blockchain Sentinel">
                        </div>
                    ...
                    <div class="agent-card lindo">
                        <div class="agent-avatar">
                            <img src="assets/lindo-avatar.png" alt="Lindo - Intelligence Oracle">
                        </div>
            ...
            <div class="features-container">
                <div class="feature-card" style="max-width: 600px; margin: 0 auto; text-align: center; border: 1px solid #c9a227; box-shadow: 0 0 30px rgba(201, 162, 39, 0.1);">
                    <div class="token-logo" style="margin-bottom: 20px;">
                        <img src="assets/guard-token-logo.png" alt="GUARD Token" width="80" height="80">
                    </div>
            ...
            <div class="tokens-grid">
                <div class="token-card">
                    <div class="token-logo">
                        <img src="assets/gs-token-logo.png" alt="SHIELD Token" width="100" height="100">
                    </div>
                ...
                <div class="token-card">
                    <div class="token-logo">
                        <img src="assets/guard-token-logo.png" alt="GUARD Token" width="100" height="100">
                    </div>
...
# 3. Deploy JavaScript (Wallet Logic)
cat << 'JS_EOF' > frontend/js/token-sale.js
...
echo "   - index.html"
echo "   - frontend/js/token-sale.js"
echo "⚠️  Don't forget to upload your images to the 'assets/' folder!"
